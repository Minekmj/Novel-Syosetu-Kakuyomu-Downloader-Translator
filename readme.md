...
**MINE DOWNLOADER**는 일본 웹소설 플랫폼인 **소설가가 되자(Syosetu)**와 **카쿠요무(Kakuyomu)**를 대상으로 작품 검색, 회차 수집, 신규 회차 확인, 번역, EPUB 변환 등을 하나의 프로그램에서 처리할 수 있도록 만든 통합형 Desktop Application입니다.
